...
class Endpoints:
    ...
    async def get_guild_audit_log(
        ...
        r = await self.api_call(
            ...
            method="GET",
            params={"user_id": user_id, "action_type": action_type, "before": before, "limit": limit},
        )
    ...
    async def crosspost_message(self, channel_id: Snowflake, message_id: Snowflake, reason: str = None) -> Message:
        ...
        """
        r = await self.api_call(
            path=f"/channels/{channel_id}/messages/{message_id}/crosspost", method="POST", reason=reason
        )
        return Message.from_dict(**r)
    ...
    async def delete_user_reaction(
        self, channel_id: Snowflake, message_id: Snowflake, emoji: int, user_id: Snowflake, reason: str = None
    ) -> None:
        """
    ...
    async def get_reactions(
        self, channel_id: Snowflake, message_id: Snowflake, emoji: int, after: Snowflake = None, limit: int = 25
    ) -> List[User]:
        """
    ...
    async def delete_all_reactions(self, channel_id: Snowflake, message_id: Snowflake, reason: str = None) -> None:
        ...
        """
        await self.api_call(
            path=f"/channels/{channel_id}/messages/{message_id}/reactions", method="DELETE", reason=reason
        )

    @Permissions("MANAGE_MESSAGES")
    async def delete_all_reactions_for_emoji(
        self, channel_id: Snowflake, message_id: Snowflake, emoji: int, reason: str = None
    ) -> None:
        """
        ...
        """
        await self.api_call(
            path=f"/channels/{channel_id}/messages/{message_id}/reactions/{emoji}", method="DELETE", reason=reason
        )
    ...
    async def add_pinned_channel_message(
        self, channel_id: Snowflake, message_id: Snowflake, reason: str = None
    ) -> None:
        """
    ...
    async def group_dm_add_recipient(
        ...
        await self.api_call(
            ...
            method="PUT",
            json={"access_token": access_token, "nick": nick},
        )
    ...
    async def list_public_archived_threads(
        self, channel_id: Snowflake, before: datetime = None, limit: int = None
    ) -> List[Thread_List]:
        """
    ...
    async def list_joined_private_archived_threads(
        self, channel_id: Snowflake, before: Snowflake = None, limit: int = None
    ) -> List[Thread_List]:
        """
    ...
    async def create_guild_emoji(
        self, guild_id: Snowflake, name: str = None, image: str = None, roles: Snowflake = None, reason: str = None
    ) -> Emoji:
        """
        ...
        r = await self.api_call(
            ...
            method="POST",
            json={"name": name, "image": image, "roles": roles},
            reason=reason,
        )
        return Emoji.from_dict(**r)
    ...
    async def modify_guild_emoji(
        self, guild_id: Snowflake, emoji_id: Snowflake, name: str = None, roles: Snowflake = None, reason: str = None
    ) -> Emoji:
        """
    ...
    async def modify_guild_channel_positions(
        ...
        await self.api_call(
            path=f"/guilds/{guild_id}/channels",
            method="PATCH",
            json={"id": id, "position": position, "lock_permissions": lock_permissions, "parent_id": parent_id},
            reason=reason,
        )
    ...
    async def list_guild_members(self, guild_id: Snowflake, limit: int = 1, after: Snowflake = 0) -> List[Guild_Member]:
        ...
        """
        r = await self.api_call(
            path=f"/guilds/{guild_id}/members", method="GET", params={"limit": limit, "after": after}
        )
    ...
    async def search_guild_members(self, guild_id: Snowflake, query: str = None, limit: int = 1) -> List[Guild_Member]:
        ...
        """
        r = await self.api_call(
            path=f"/guilds/{guild_id}/members/search", method="GET", params={"query": query, "limit": limit}
        )
        return [Guild_Member.from_dict(**i) for i in r]
    ...
    async def add_guild_member(
        ...
        nick: str = None,
        roles: Snowflake = None,
        mute: bool = False,
        deaf: bool = False,
    ) -> Union[Guild_Member, None]:
        """
        ...
        r = await self.api_call(
            ...
            method="PUT",
            json={"access_token": access_token, "nick": nick, "roles": roles, "mute": mute, "deaf": deaf},
        )
        if r:
            return Guild_Member.from_dict(**r)
    ...
    async def modify_guild_member(
        ...
        if deaf is not None:
            kwargs["deaf"] = deaf
        r = await self.api_call(
            path=f"/guilds/{guild_id}/members/{user_id}", method="PATCH", json=kwargs, reason=reason, nullable=nullable
        )
        return Guild_Member.from_dict(**r)
    ...
    async def modify_current_user_nick(self, guild_id: Snowflake, nick: str = None, reason: str = None) -> str:
        ...
        """
        r = await self.api_call(
            path=f"/guilds/{guild_id}/members/@me/nick", method="PATCH", json={"nick": nick}, reason=reason
        )
        return r
    ...
    async def remove_guild_member_role(
        ...
        """
        await self.api_call(
            path=f"/guilds/{guild_id}/members/{user_id}/roles/{role_id}", method="DELETE", reason=reason
        )
    ...
    async def create_guild_ban(
        self, guild_id: Snowflake, user_id: Snowflake, delete_message_days: int = None, reason: str = None
    ) -> None:
        """
    ...
    async def create_guild_role(
        ...
        guild_id: Snowflake,
        name: str = "new_role",
        permissions: str = "@everyone_permissions_in_guild",
        color: int = None,
        hoist: bool = False,
        icon: str = None,
    ...
    async def modify_guild_role_positions(
        ...
        """
        r = await self.api_call(
            path=f"/guilds/{guild_id}/roles", method="PATCH", json=[{"id": id, "position": position}], reason=reason
        )
        return [Role.from_dict(**i) for i in r]
    ...
    async def get_guild_prune_count(
        ...
        """
        r = await self.api_call(
            path=f"/guilds/{guild_id}/prune", method="GET", params={"days": days, "include_roles": include_roles}
        )
    ...
    async def modify_guild_welcome_screen(
        ...
        r = await self.api_call(
            ...
            method="PATCH",
            json={"enabled": enabled, "welcome_channels": welcome_channels, "description": description},
        )
        return Welcome_Screen.from_dict(**r)
    ...
    async def modify_stage_instance(self, channel_id: int, topic: str = "", privacy_level: int = 0) -> None:
        ...
        """
        await self.api_call(
            path=f"/stage-instances/{channel_id}", method="PATCH", json={"topic": topic, "privacy_level": privacy_level}
        )
    ...
    async def get_current_user_guilds(
        ...
        """
        r = await self.api_call(
            path=f"/users/@me/guilds", method="GET", params={"before": before, "after": after, "limit": limit}
        )
    ...
    async def create_group_dm(self, access_tokens: List[str] = None, nicks: dict = dict) -> Channel:
        ...
        """
        r = await self.api_call(
            path=f"/users/@me/channels", method="POST", json={"access_tokens": access_tokens, "nicks": nicks}
        )
        return Channel.from_dict(**r)
    ...
    async def create_webhook(
        self, channel_id: Snowflake, name: str = None, avatar: str = None, reason: str = None
    ) -> Webhook:
        """
        ...
        """
        r = await self.api_call(
            path=f"/channels/{channel_id}/webhooks", method="POST", json={"name": name, "avatar": avatar}, reason=reason
        )
    ...
    async def execute_slack_compatible_webhook(
        self, webhook_id: Snowflake, webhook_token: int, wait: bool = False, json: dict = None
    ) -> Union[Message, None]:
        """
        ...
        """
        r = await self.api_call(
            path=f"/webhooks/{webhook_id}/{webhook_token}/slack", method="POST", params={"wait": wait}, json=json
        )
        if r:
            return Message.from_dict(**r)
    ...
    async def execute_github_compatible_webhook(
        ...
        """
        r = await self.api_call(
            path=f"/webhooks/{webhook_id}/{webhook_token}/github", method="POST", params={"wait": wait}, json=json
        )
        if r:
            return Message.from_dict(**r)
    ...
    async def delete_webhook_message(
        self, webhook_id: Snowflake, webhook_token: Snowflake, message_id: Snowflake, reason: str = None
    ) -> None:
        """Deletes a message that was created by the webhook. Returns a 204 NO CONTENT response on success."""
        await self.api_call(
            path=f"/webhooks/{webhook_id}/{webhook_token}/messages/{message_id}", method="DELETE", reason=reason
        )
    ...
    async def bulk_overwrite_global_application_commands(
        ...
        """
        r = await self.api_call(
            path=f"/applications/{application_id}/commands", method="PUT", json=application_commands
        )
        return [Application_Command.from_dict(**i) for i in r]
    ...
    async def get_guild_application_command(
        ...
        """
        r = await self.api_call(
            path=f"/applications/{application_id}/guilds/{guild_id}/commands/{command_id}", method="GET"
        )
        return Application_Command.from_dict(**r)
    ...
    async def delete_guild_application_command(
        ...
        """
        await self.api_call(
            path=f"/applications/{application_id}/guilds/{guild_id}/commands/{command_id}", method="DELETE"
        )
    ...
    async def bulk_overwrite_guild_application_commands(
        ...
        """
        r = await self.api_call(
            path=f"/applications/{application_id}/guilds/{guild_id}/commands", method="PUT", json=application_commands
        )
        return [Application_Command.from_dict(**i) for i in r]

    async def create_interaction_response(
        self, interaction_id: Snowflake, interaction_token: int, response: Interaction_Response
    ) -> None:
        """
        ...
        """
        await self.api_call(
            path=f"/interactions/{interaction_id}/{interaction_token}/callback", method="POST", json=as_dict(response)
        )
    ...
    async def delete_followup_message(
        self, application_id: Snowflake, interaction_token: int, message_id: Snowflake
    ) -> None:
        """
        Deletes a followup message for an Interaction. Returns `204` on success.
        """
        await self.api_call(
            path=f"/webhooks/{application_id}/{interaction_token}/messages/{message_id}", method="DELETE"
        )
    ...
    async def get_guild_application_command_permissions(
        ...
        """
        r = await self.api_call(
            path=f"/applications/{application_id}/guilds/{guild_id}/commands/permissions", method="GET"
        )
    ...
    async def get_application_command_permissions(
        ...
        """
        r = await self.api_call(
            path=f"/applications/{application_id}/guilds/{guild_id}/commands/{command_id}/permissions", method="GET"
        )
    ...
    async def batch_edit_application_command_permissions(
        ...
        r = await self.api_call(
            ...
            method="PUT",
            json=[{"id": i.id, "permissions": i.permissions} for i in command_permissions],
            reason=reason,
        )
        return [Guild_Application_Command_Permissions.from_dict(**i) for i in r]
